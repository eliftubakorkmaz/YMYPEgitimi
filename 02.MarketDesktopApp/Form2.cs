    ...
    public partial class Form2 : Form
    {
        ...
        private void GetReceipts()
        {
            ...
            while (reader.Read())
            {
                ...
                dgReceipts.Rows[rowCount].Cells["Remaining"].Value = reader["Remaing"];
        ...
        private void GetReceiptPayments(int receiptId)
        {
            ...
            while (receiptPaymentReader.Read())
            {
                ...
                int dgReceiptPaymentCount = dgReceiptPayments.Rows.Count - 1;

                dgReceiptPayments.Rows[dgReceiptPaymentCount].Cells["RPCount"].Value = dgReceiptPaymentCount + 1;
                dgReceiptPayments.Rows[dgReceiptPaymentCount].Cells["RPType"].Value = receiptPaymentReader["Type"];
                dgReceiptPayments.Rows[dgReceiptPaymentCount].Cells["RPAmount"].Value = receiptPaymentReader["Amount"];
            }
            dgReceiptPayments.ClearSelection();
            receiptPaymentReader.Close();
        }

        private void GetReceiptsDetails(int receiptId)
        {
        ...
        private void dgReceipts_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgReceipts.Columns[e.ColumnIndex].Name == "BtnPrint")
            {
                ...
                sheet.Cells[1, 1] = "ELİF TUBA MARKET RECEIPT";

                sheet.Range["A1", "C1"].Merge(true);
                sheet.Range["A2", "C1"].Merge(true);
                ...
                sheet.Cells[3, 2] = "8ebfab9e-fc6f-4295-972a-959564c66b34";
                ...
                //sheet.PrintOutEx(1);
                book.SaveAs("C:\\YMYP\\Receipt.xlsx");
